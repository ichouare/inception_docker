...
/usr/local/bin/wp core install --url=$DOMAINE_NAME --title=$WP_TITLE --admin_user=$db_user --admin_password=$db_pwd --admin_email=$WP_ADMIN_EMIAL --skip-email=  --path='/var/www/wordpress' --allow-root
